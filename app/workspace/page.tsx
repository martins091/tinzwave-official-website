              ...
              <Reveal key={index}>
                <div className="group relative rounded-2xl overflow-hidden border border-white/10 bg-white/5 backdrop-blur-sm hover:bg-white/10 transition-all duration-500 hover:scale-[1.02] hover:shadow-2xl hover:shadow-white/10 h-full flex flex-col">
                  ...
                  <div className="relative w-full h-56 overflow-hidden bg-gradient-to-b from-[#03005F]/20 to-black/80">
                    ...
                    <div className="relative w-full h-full">
                      {space.image ? (
                        ...
                        <div className="w-full h-full flex items-center justify-center bg-[#03005F]/10">
                          <div className="w-20 h-20 rounded-2xl bg-gradient-to-br from-[#03005F] to-indigo-600 flex items-center justify-center shadow-2xl shadow-[#03005F]/30">
                    ...
                    {/* Capacity Badge */}
                    <div className="absolute bottom-4 left-4 z-20 px-3 py-1.5 rounded-full border border-white/20 bg-black/60 backdrop-blur-xl text-xs text-white/60 font-mono">
                  ...
                  <div className="relative p-6 flex flex-col flex-1">
                    <h3 className="text-xl font-bold text-white mb-2 group-hover:text-transparent group-hover:bg-clip-text group-hover:bg-gradient-to-r group-hover:from-white group-hover:to-indigo-300 transition duration-500">
                      {space.title}
                    </h3>
                    ...
                    <Link
                      href="/contact"
                      className="inline-flex items-center gap-2 text-sm font-medium text-white/50 hover:text-white transition group"
                    >
